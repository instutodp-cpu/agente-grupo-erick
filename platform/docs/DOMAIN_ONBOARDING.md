...
`CONNECTOR_LIFECYCLE_RUNTIME_REGISTRY.md` is the lifecycle step after a domain
has contract, provider candidate, mock parity and readiness evidence. It keeps
registration and lifecycle governance separate from real provider activation.
